...
const MapAnimation = () => {
	...
	const arrows = map.querySelector('[data-name="arrows"]').querySelectorAll(":scope > *");
	const labels = map.querySelector('[data-name="labels"]').querySelectorAll(":scope > *");
	...
	const circleLocationPulse = map.querySelector('[data-name="circle-location-pulse"]');
