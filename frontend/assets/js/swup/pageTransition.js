...
const containerHtml = `<div id="page-transition" style="--cols: ${numCols}; --rows: ${numRows};" class="fixed inset-0 z-10 pointer-events-none grid grid-cols-[repeat(var(--cols),minmax(0,1fr))] grid-rows-[repeat(var(--rows),minmax(0,1fr))] border-white border-(length:--padding) max-md:border-0 overflow-clip"></div>`
