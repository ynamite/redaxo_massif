        ...
        <media-controls-group class="-mt-0.5 flex w-full items-center px-2 pb-2">
          <?php if (in_array('play-button', $controls)) : ?>
            ...
            <media-tooltip>
              ...
              <media-tooltip-content class="animate-out fade-out slide-out-to-bottom-2 data-[visible]:animate-in data-[visible]:fade-in data-[visible]:slide-in-from-bottom-4 z-10 rounded-sm bg-black/90 px-2 py-0.5 text-sm font-medium text-white" placement="top start" offset="30">
          ...
          <?php if (in_array('mute-button', $controls)) : ?>
            ...
            <media-tooltip>
              ...
              <media-tooltip-content class="animate-out fade-out slide-out-to-bottom-2 data-[visible]:animate-in data-[visible]:fade-in data-[visible]:slide-in-from-bottom-4 z-10 rounded-sm bg-black/90 px-2 py-0.5 text-sm font-medium text-white" placement="top" offset="30">
              ...
              <media-menu-items class="animate-out fade-out slide-out-to-bottom-2 data-[open]:animate-in data-[open]:fade-in data-[open]:slide-in-from-bottom-4 flex h-(--menu-height) max-h-[400px] min-w-[260px] flex-col overflow-y-auto overscroll-y-contain rounded-md border border-white/10 bg-black/95 p-2.5 font-sans text-[15px] font-medium outline-none backdrop-blur-sm transition-[height] duration-300 will-change-[height] data-resizing:overflow-hidden" offset="30" placement="top end">
                ...
                <media-menu>
                  ...
                  <media-menu-button class="ring-media-focus parent left-0 z-10 flex w-full cursor-pointer select-none items-center justify-start rounded-sm bg-black/60 p-2.5 outline-none ring-inset aria-disabled:hidden aria-hidden:hidden data-open:sticky data-open:-top-2.5 data-hocus:bg-white/10 data-focus:ring-[3px]">
                    ...
                    <!-- Icon -->
                    <media-icon class="parent-data-[open]:hidden mr-1.5 h-5 w-5" type="closed-captions"></media-icon>
                    <!-- Label -->
                    <span>Captions</span>
                    <!-- Hint -->
          ...
          <?php if (in_array('fullscreen-button', $controls)) : ?>
            ...
            <media-tooltip>
              ...
              <media-tooltip-content class="animate-out fade-out slide-out-to-bottom-2 data-[visible]:animate-in data-[visible]:fade-in data-[visible]:slide-in-from-bottom-4 z-10 rounded-sm bg-black/90 px-2 py-0.5 text-sm font-medium text-white" placement="top end" offset="30">
